...
func Register(r *gin.Engine, requestorMiddleware *httpmiddleware.RequestorMiddleware, userHandler *userhttp.Handler, subscriptionHandler *subscriptionhttp.Handler) {
	api := r.Group("/api")
